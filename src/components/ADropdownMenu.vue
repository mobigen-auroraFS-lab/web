...
<template>
  <div ref="root" class="relative inline-flex font-sans">
    ...
    <div v-if="open" class="absolute top-[calc(100%+6px)] left-0 w-60 rounded-lg border border-border-default bg-bg-surface shadow-elevation-2 overflow-hidden z-10">
